...
export function PiggyBank({ difficulty }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#FFF0F5] flex flex-col">
      ...
      <div className="flex-1 flex flex-col p-4 overflow-y-auto">
        {/* Goal Display */}
        <div className="bg-white rounded-2xl p-4 mb-4 shadow-sm border-2 border-pink-200">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              <div className="text-4xl">{goal.emoji}</div>
              <div>
                <p className="font-bold text-gray-800">{goal.name}</p>
                <p className="text-sm text-gray-500">Goal: £{goal.targetAmount}</p>
              </div>
            </div>
            <div className="text-right">
              <p className="text-2xl font-black text-pink-500">£{savings}</p>
          ...
          <AnimatePresence mode="wait">
            {phase === "intro" && (
              ...
              >
                ...
                <button
                  ...
                  className="px-8 py-4 bg-[#FF6B9D] text-white font-bold rounded-2xl text-lg hover:opacity-90 active:scale-95 transition-all"
                >
                  Start Saving! 🚀
                </button>
              </motion.div>
            ...
            {phase === "earning" && (
              ...
              >
                ...
                <p className="text-gray-500 text-sm mb-2">{round.scenario}</p>
                <motion.p
                  className="text-4xl font-black text-green-500 mb-6"
                  initial={{ scale: 0.5 }}
                  animate={{ scale: 1 }}
                ...
                <button
                  ...
                  className="px-8 py-4 bg-green-500 text-white font-bold rounded-2xl text-lg hover:opacity-90 active:scale-95 transition-all"
                >
                  Continue →
                </button>
              </motion.div>
            ...
            {phase === "decision" && round.temptation && (
              ...
              >
                ...
                <div className="bg-orange-50 border-2 border-orange-200 rounded-2xl p-4 mb-6">
                  <div className="text-4xl mb-2">{round.temptation.emoji}</div>
                  <p className="font-bold text-gray-800">{round.temptation.name}</p>
                  <p className="text-orange-600 font-bold">£{round.temptation.cost}</p>
                ...
                <div className="flex gap-3">
                  <button
                    onClick={handleSpend}
                    className="flex-1 py-4 bg-orange-400 text-white font-bold rounded-2xl hover:opacity-90 active:scale-95 transition-all"
                  >
                  ...
                  <button
                    onClick={handleSave}
                    className="flex-1 py-4 bg-pink-500 text-white font-bold rounded-2xl hover:opacity-90 active:scale-95 transition-all"
                  >
                    <span className="text-xl">🐷</span>
                    <br />
                    Save All!
              ...
              >
                {lastChoice === "save" ? (
                  <>
                    ...
                    <h3 className="text-xl font-bold text-green-600 mb-2">Great Choice!</h3>
                ...
                <button
                  ...
                  className="mt-6 px-8 py-4 bg-[#FF6B9D] text-white font-bold rounded-2xl text-lg hover:opacity-90 active:scale-95 transition-all"
                >
          ...
          >
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  onClick={initGame}
                  className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-pink-100 text-pink-700 font-bold hover:bg-pink-200"
                >
                ...
                <button
                  onClick={() => router.push("/games/finance")}
                  className="flex-1 py-3 rounded-xl bg-[#FF6B9D] text-white font-bold hover:opacity-90"
                >
                  Back to Hub
                </button>
              </div>
